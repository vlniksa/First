...
public class calc_new {
		...
		boolean arab= false;
		boolean rim= false;
		boolean oparab1= false;
		boolean oparab2= false;
		boolean oprim1= false;
		boolean oprim2= false;
		...
		//System.out.println(words.length);
			...
			strop1=check_op(words[0]);
			//strop=check_operator(words[1]);
			strop2=check_op(words[2]);
		}
...
public static int check_op(String param1) {
			int substr_str = 0;
			System.out.println(param1);
			if (   (param1.equals("1") //проверка на соотвествие 1-го операнда
					|| param1.equals("2") 
					|| param1.equals("3") 
					|| param1.equals("4") 
					|| param1.equals("5") 
				...
				//correct=true;
				System.out.println(substr_str);
				return substr_str;
			}

	/*public static String check_operator (String param1) {
		String tip_op=" ";
		if ((	param1.equals("+") 
				|| param1.equals("-") 
				|| param1.equals("*")
